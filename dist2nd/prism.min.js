/* PrismJS 1.23.0
https://prismjs.com/download.html#themes=prism-coy&languages=markup+css+clike+javascript+bash+csharp+css-extras+git+http+ignore+java+javadoc+javadoclike+javastacktrace+js-extras+json+json5+jsonp+jsstacktrace+js-templates+markup-templating+mongodb+php+phpdoc+php-extras+powershell+regex+rest+sass+sql+visual-basic+xml-doc&plugins=line-highlight+line-numbers+show-language+inline-color+toolbar+copy-to-clipboard+treeview */
